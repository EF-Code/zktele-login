...
export function loadConfig(env = process.env) {
  ...
  const databaseSsl = booleanEnv(env.DATABASE_SSL);
  if (production && relyingRole && !databaseSsl) throw new Error('DATABASE_SSL=true is required on the relying service in production');
